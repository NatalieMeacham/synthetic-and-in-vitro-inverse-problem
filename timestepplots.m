function timestepplots(sprobs100,optweightfromAIC100,optweightfromAIC25,optweightfromAIC10,weightedsol100,weightedsol25,weightedsol10,Sweightedsol100,Sweightedsol25,Sweightedsol10,disttype,t,weightedsol,noisesize)
points = 101;
...
legend('Recovered, N_t=100','Recovered, N_t=25','Recovered, N_t=10','Original','Location','best','FontSize',12)
set(gca,"FontSize",20)
...
legend('Synthetic Data, N_t=100','Recovered Curve, N_t=100','Synthetic Data, N_t=25','Recovered Curve, N_t=25','Synthetic Data, N_t=10','Recovered Curve, N_t=10','Original Curve','Location','best','FontSize',12)
set(gca,"FontSize",20)
...
if strcmp(disttype,'OnePoint') == 1 || strcmp(disttype,'TwoPoints') ==1 
  ...
  %  yyaxis left
    ...
    ylimval=max([max(optweightfromAIC100),max(optweightfromAIC25),max(optweightfromAIC10),max(sprobs100)]);
    ylim([0 ylimval])
    legend('Recovered, N_t=100','Recovered, N_t=25','Recovered, N_t=10','Original','Location','best','FontSize',12)
    set(gca,"FontSize",20)
    xlabel('Sensitivity to Treatment {\it s}')
